...
class _VolunteerState extends State<Volunteer> {
  ...
  List<Question> publicvolunteer = [
    Question(
      questionText: 'ما الهدف من هذه المبادرة؟',
      options: [
        '🤝 تقديم مساعدة مباشرة',
        '🎓 نشر التوعية أو التعليم',
        '🎉 تنظيم فعالية اجتماعية',
        '💬 دعم نفسي أو معنوي',
      ],
    ),
    Question(
      questionText: 'من الفئة المستهدفة؟',
      options: [
        '👶 أطفال',
        '🧒 شباب',
        '👴 كبار السن',
    ...
    Question(
      questionText: 'أين ستقام المبادرة؟',
      options: [
        '🏠 مقر الجمعية',
        '🏫 مدرسة أو جامعة',
        '🏞 مكان عام',
    ...
    Question(
      questionText: 'هل تحتاجون إلى متطوعين؟',
      options: ['✅ نعم، نحتاج متطوعين', '❌ لا، لا نحتاج متطوعين حاليًا'],
    ),
    Question(
      questionText: 'هل ستتضمن المبادرة تغطية إعلامية؟',
      options: ['📷 نعم، سيتم التوثيق', '❌ لا، المبادرة خاصة بدون تصوير'],
    ),
    Question(
      questionText: 'كم عدد المستفيدين المتوقع؟',
      options: [
        '👤 أقل من 50 شخص',
        '👥 بين 50 و200 شخص',
        '👨‍👩‍👧‍👦 أكثر من 200 شخص',
